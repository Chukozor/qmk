...
// keycodes utilisables : APEX_CTL, APEX_I, KC_LCTL, KC_I
  ...
  //,-----------------------------------------------------------.                    ,-----------------------------------------------------.
       KC_ESC,LALT(KC_F7),    KC_H,      KC_F8, XXXXXXX,  KC_TAB,                      XXXXXXX, XXXXXXX, XXXXXXX, KC_ACL0, KC_ACL1, KC_ACL2,
  //|--------+-----------+--------+-----------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LCTL,    XXXXXXX,   KC_P4,LALT(KC_F5),   KC_P6, XXXXXXX,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  //|--------+-----------+--------+-----------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LSFT,LALT(KC_F2),   KC_P1,      KC_P2,   KC_P3, XXXXXXX,                      XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,
  //|--------------------------------------------------------------|   |-------------------------------------------------------------|
  ...
  //,------------------------------------------------------------.                    ,--------------------------------------------------------.
       MY_ESC,     KC_NUM, KC_NUBS,S(KC_NUBS),   XXXXXXX, XXXXXXX,                      XXXXXXX,  KC_EQL, KC_NUBS, S(KC_NUBS), XXXXXXX, XXXXXXX,
  //|--------+-----------+--------+----------+----------+--------|                    |--------+--------+--------+-----------+--------+--------|
  ...
  //|-----------------------------------------------------|    |----------------------------------------------------------|
                        XXXXXXX,          KC_LSFT, KC_LCTL, MO(_ACCENTS),  KC_BTN1, KC_BTN3, TG_SCROL,         KC_BTN2
                     //`------------------------------------------------'    `-------------------------------------------'
  ),
   // _ACCENTS_COLEMAK_FR
