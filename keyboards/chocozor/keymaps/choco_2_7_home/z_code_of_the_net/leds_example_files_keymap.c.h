...
qk_tap_dance_action_t tap_dance_actions[] = {
    ...
    [TD_F9_PASTE]     = ACTION_TAP_DANCE_DOUBLE(KC_F9, G(KC_V)),
    [TD_F10_HUEON]     = ACTION_TAP_DANCE_DOUBLE(KC_F10, S(G(KC_1))),
    [TD_F11_HUEMUSIC]   = ACTION_TAP_DANCE_DOUBLE(KC_F11, S(G(KC_2))),
    [TD_F12_HUEVIDEO]   = ACTION_TAP_DANCE_DOUBLE(KC_F12, S(G(KC_3)))
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT(
        ...
        TD(TD_F7_CLIPSCREEN), TD(TD_F8_CLIPSELECT), TD(TD_F9_PASTE),
        TD(TD_F10_HUEON),   TD(TD_F11_HUEMUSIC),   TD(TD_F12_HUEVIDEO)
    ),
